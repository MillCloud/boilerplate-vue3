<template>
  <a-row>
    <a-col :span="24">
      <h3 class="text-center prose-2xl">{{ msg }}</h3>
    </a-col>
    <a-col :span="24">
      <p class="text-center">
        For a guide and recipes on how to configure / customize this project, check out the
        <a href="https://cn.vitejs.dev/" target="_blank" rel="noopener noreferrer">
          vite documentation
        </a>
      </p>
    </a-col>
    <a-col :span="24" class="mt-2">
      <h6 class="text-center prose-lg">Installed Plugins</h6>
    </a-col>
    <a-col :span="24" class="text-center">
      ...
      <a
        class="mx-2"
        href="https://github.com/intlify/bundle-tools/tree/main/packages/vite-plugin-vue-i18n"
        target="_blank"
        rel="noopener noreferrer"
      >
        vue-i18n
      ...
      <a
        class="mx-2"
        href="https://github.com/vitejs/vite/tree/main/packages/plugin-legacy"
        target="_blank"
        rel="noopener noreferrer"
      >
        legacy
      ...
      <a
        class="mx-2"
        href="https://github.com/IndexXuan/vite-plugin-env-compatible"
        target="_blank"
        rel="noopener noreferrer"
      >
        env
      ...
      <a
        class="mx-2"
        href="https://github.com/antfu/vite-plugin-restart"
        target="_blank"
        rel="noopener noreferrer"
      >
        restart
    ...
    <a-col :span="24" class="mt-2">
      <h6 class="text-center prose-lg">Ecosystem</h6>
    </a-col>
    <a-col :span="24" class="text-center">
      <a class="mx-2" href="https://cn.vuejs.org" target="_blank" rel="noopener noreferrer">
        vue
      </a>
      ...
      <a
        class="mx-2"
        href="https://vue-query.vercel.app/"
        target="_blank"
        rel="noopener noreferrer"
      >
        vue-query
